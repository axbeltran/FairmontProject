...
//$path_to_images = isset($_GET['directory/img/gallery']) ? strip_tags($_GET['directory/img/gallery']) : '';
...
$path = empty($_SERVER['img/gallery'])?
$_SERVER['PHP_SELF']:$_SERVER['img/gallery'];
